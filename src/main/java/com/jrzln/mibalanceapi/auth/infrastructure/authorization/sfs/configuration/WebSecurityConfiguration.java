package com.jrzln.mibalanceapi.auth.infrastructure.authorization.sfs.configuration;

import com.jrzln.mibalanceapi.auth.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.jrzln.mibalanceapi.auth.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.jrzln.mibalanceapi.auth.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(configurer -> configurer.configurationSource(lambda -> {
